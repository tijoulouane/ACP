...
Pour analyser les relations entre les variables quantitatives du jeu de données, soit les différents secteurs d’émissions de CO₂, nous utilisons le coefficient de corrélation de Pearson, puisque la matrice de corrélation servira par la suite à l’Analyse en Composantes Principales^[voir annexe: Graphiques 6].
...
\underline{Graphique 9} : Relations entre les émissions de CO₂ de différents secteurs avec droites de régression
...
\underline{Graphique 10} : Répartition des émissions de CO₂ par secteur et département
...
# Graphique 24 : Eboulis des valeurs propres pour l'ACP par régio
fviz_eig(reg_acp,
         addlabels = TRUE,
         main = "Eboulis des valeurs propres")
