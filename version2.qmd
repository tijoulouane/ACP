...
## acp sur groupes
```{r}
depts_a_exclure <- c("89", "44", "69", "59", "13", "85", "84", "83", "82")
##BIZARRE 


Base_dep_filtree <- base_dep_finale_clean[!base_dep_finale_clean$dep_code %in% depts_a_exclure,]

pca9 <- PCA(Base_dep_filtree[, variables_quanti_finales], scale.unit = TRUE, graph = FALSE)
