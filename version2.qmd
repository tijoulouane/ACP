...
## acp sur groupes
```{r}
base_dep_finale_clean$Total_CO2 <- rowSums(base_dep_finale_clean[, variables_quanti_finales])

Base_dep_ratios <- base_dep_finale_clean
Base_dep_ratios[, variables_quanti_finales] <- (Base_dep_ratios[, variables_quanti_finales] / Base_dep_ratios$Total_CO2) * 100

pca_9 <- PCA(Base_dep_ratios[, variables_quanti_finales], scale.unit = TRUE, graph = FALSE)
